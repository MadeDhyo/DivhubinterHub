...
export default function AuthenticatedLayout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-[#001b3d] font-sans text-white flex flex-col justify-between relative selection:bg-[#d4af37] selection:text-[#001b3d]">
            {/* Top Gold Navigation Progress Loader */}
            {isNavigating && (
            ...
            <div className="flex flex-1 relative">
                ...
                <aside className={`fixed top-0 bottom-0 left-0 z-40 w-64 bg-[#031433]/90 backdrop-blur-md border-r border-white/10 flex flex-col justify-between p-6 transition-transform duration-300 md:translate-x-0 ${
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex items-center gap-3 border-b border-white/10 pb-6">
                            <img
                                ...
                                className="h-14 w-auto object-contain drop-shadow-[0_0_8px_rgba(212,175,55,0.3)] transition-transform duration-300 hover:scale-105"
                                onError={(e) => {
                            ...
                            {user?.role === 'admin' && (
                                <>
                                    ...
                                    <Link
                                        ...
                                        className="flex items-center gap-3 px-4 py-3 rounded-lg font-semibold text-sm text-gray-300 hover:bg-white/5 hover:text-white transition gold-glow-hover"
                                    >
                                        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="text-right hidden sm:block">
                                    ...
                                    <p className="text-[10px] text-[#d4af37] font-bold tracking-widest uppercase">
                                        {user?.role ? `Role: ${user.role}` : 'Pusat Komando Operasional'}
                                    </p>
                                </div>
