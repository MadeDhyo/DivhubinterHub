                    ...
                    <div className="overflow-hidden bg-[rgba(10,31,73,0.7)] border border-white/10 shadow-lg rounded-xl p-6 backdrop-blur-md text-white">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-white/10">
                            <div>
                                ...
                                <p className="text-xs text-gray-400 mt-1">Kelola akun pengguna, wewenang akses, dan role personil NCB Interpol.</p>
                            </div>
                            <button
                                    ...
                                    {users.map(user => (
                                        <tr key={user.id} className="hover:bg-white/5 transition">
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                {user.id === auth.user.id ? (
                                                    <span className="text-xs text-gray-500 italic select-none" title="Tidak dapat menghapus akun sendiri">
                                                        Locked
                                                    </span>
                                                ) : (
                                                    <button
                                                        onClick={() => handleDeleteUser(user.id, user.name)}
                                                        className="text-xs font-bold text-red-400 hover:text-red-300 transition uppercase tracking-wider p-1"
                                                        title="Hapus Akun"
                                                    >
                                                        Hapus
                                                    </button>
