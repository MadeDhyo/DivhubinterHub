    ...
    return (
        <div className="min-h-screen bg-[#001b3d] flex flex-col items-center justify-center p-4 font-sans text-white relative overflow-hidden bg-cover bg-center" style={{ backgroundImage: "url('/images/login_bg.jpg')" }}>
            ...
            <div className={`w-full max-w-[450px] bg-[#031433]/85 border border-white/10 shadow-2xl rounded-2xl p-8 backdrop-blur-md relative z-10 overflow-hidden border-t-4 border-t-[#d4af37] transition-all duration-300 ${
                hasErrors ? 'animate-shake border-t-red-500 shadow-[0_0_25px_rgba(239,68,68,0.3)]' : 'animate-fade-in-up'
            }`}>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#d4af37] hover:bg-[#b5952f] active:bg-[#9c7f23] text-[#001b3d] font-bold py-3.5 px-4 rounded-lg text-xs uppercase tracking-widest transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-[0_0_20px_rgba(212,175,55,0.35)] disabled:opacity-75 disabled:cursor-not-allowed"
                        disabled={processing}
                    >
                        {processing ? (
                            <>
