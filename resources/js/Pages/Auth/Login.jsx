...
export default function Login({ status, canResetPassword }) {
    ...
    return (
        <div className="min-h-screen bg-[#001b3d] flex flex-col items-center justify-center p-4 font-sans text-white relative overflow-hidden bg-cover bg-center" style={{ backgroundImage: "url('/images/login_bg.jpg')" }}>
            ...
            <div className="w-full max-w-[450px] bg-[#031433]/85 border border-white/10 shadow-2xl rounded-2xl p-8 backdrop-blur-md relative z-10 overflow-hidden border-t-4 border-t-[#d4af37]">
                ...
                <div className="flex flex-col items-center mb-6">
                    <img
                        ...
                        alt="INTERPOL Logo"
                        className="h-16 w-auto object-contain mb-1.5 drop-shadow-md"
                        onError={(e) => {
                ...
                {status && (
                    <div className="mb-4 p-3 rounded bg-emerald-500/10 border border-emerald-500/20 text-sm font-semibold text-emerald-400 text-center">
                        {status}
                    </div>
                )}
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-[#001b3d]/50 border border-white/10 rounded-lg pl-10 pr-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#d4af37] focus:ring-1 focus:ring-[#d4af37] transition"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                value={data.password}
                                placeholder="••••••••"
                                className="w-full bg-[#001b3d]/50 border border-white/10 rounded-lg pl-10 pr-10 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-[#d4af37] focus:ring-1 focus:ring-[#d4af37] transition"
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <label className="flex items-center select-none cursor-pointer">
                            ...
                            />
                            <span className="ms-2 text-xs font-semibold text-gray-300">
                                Ingat Saya
                            </span>
                        </label>
                        ...
                        {canResetPassword && (
                            <Link
                                ...
                                className="text-xs font-semibold text-[#d4af37] hover:text-[#b5952f] transition"
                            >
                                Lupa Password?
                            </Link>
                        )}
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#d4af37] hover:bg-[#b5952f] active:bg-[#9c7f23] text-[#001b3d] font-bold py-3 px-4 rounded-lg text-xs uppercase tracking-widest transition flex items-center justify-center gap-2 shadow-lg disabled:opacity-50"
                        disabled={processing}
                    >
                        {processing ? (
