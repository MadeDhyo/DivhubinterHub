...
class DummyDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            \App\Models\ChecklistTemplateItem::create(['checklist_template_id' => $template->id, 'name' => 'Identifikasi Profil Target', 'is_mandatory' => true]),
            \App\Models\ChecklistTemplateItem::create(['checklist_template_id' => $template->id, 'name' => 'Cek Status Red Notice Interpol', 'is_mandatory' => true]),
            \App\Models\ChecklistTemplateItem::create(['checklist_template_id' => $template->id, 'name' => 'Koordinasi Pointers NCB Negara Asal', 'is_mandatory' => false])
        ];
